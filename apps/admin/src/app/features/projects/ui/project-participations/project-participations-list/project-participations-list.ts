...
type ProjectParticipationListItem = Omit<IProjectParticipation, 'user'> & {
  user: IProjectParticipation['user'] | null;
};
...
export class ProjectParticipationsList {
  ...
  participations = computed<ProjectParticipationListItem[]>(() => this.store.participations());
  ...
  phaseSummary(participation: Pick<IProjectParticipation, 'phases'>): string {
